    ...
    return (
        <section id="about" className="content-section">
            <div className="inner">
                ...
                <strong className="title--xl title--about split word">Yes I can do!</strong>
                <div className="text--about-inner split line">
                    <p className="text--sm text--about">
                        <span>안녕하세요, 웹 퍼블리셔 고하늘입니다.</span>
                        <span>HTML, CSS, JavaScript를 기반으로 웹 접근성과 웹 표준을 고려한 반응형 UI를 구현하고 있습니다.</span>
                    </p>
                    <p className="text--sm text--about">
